...
def ligand_scanner_all_database(pdbpath):
    ...
    for dictionary_of_process_counts in pool.map(ligand_scanner, glob.iglob(pdbpath)):
        ...
        dictionary_of_database_results['extra_in_cutoff_residue_list'].append(dictionary_of_process_counts['extra_in_cutoff_residue_list'])
...
# Write results
f = open('ligand_scanner_results_extra_in_cutoff_analysis.txt', 'w')
